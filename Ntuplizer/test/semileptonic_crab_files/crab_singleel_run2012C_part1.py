...
config.General.requestName = 'SingleEl_Run2012C_part1_v1'
...
config.Data.inputDataset = '/SingleElectron/StoreResults-V2-Run2012C-22Jan2013-v1_TLBSM_53x_v3-45cbb6c27540456f7aaf244304c73a89/USER'
config.Data.unitsPerJob = 80
config.Data.splitting = 'LumiBased'
config.Data.lumiMask = '../Cert_190456-208686_8TeV_22Jan2013ReReco_Collisions12_JSON.txt'
#config.Data.publishDataName = 'SingleEl_Run2012C_part1_v1'
